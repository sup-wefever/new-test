...
export const constantRouterMap = [
  ...
  {
    path: '/producte',
    redirect: '/producte/producte-list',
    name: 'producte-list',
    component: Layout,
    meta: { title: '产品管理', icon: 'gl' },
    children: [
      {
        path: 'producte-list',
        name: 'producte-list',
        component: () => import('@/views/producte/list'),
        meta: { title: '产品管理', icon: 'gl' }
      }
    ]
  },
  {
    path: '/personControl',
    redirect: '/personControl/personControl-list',
    name: 'personControl-list',
    component: Layout,
    meta: { title: '人员管理', icon: 'gl' },
    children: [
      {
        path: 'personControl-list',
        name: 'personControl-list',
        component: () => import('@/views/personControl/list'),
        meta: { title: '人员管理', icon: 'gl' }
      }
    ]
  }
